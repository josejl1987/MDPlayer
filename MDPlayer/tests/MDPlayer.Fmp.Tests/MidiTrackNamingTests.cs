...
public sealed class MidiTrackNamingTests
{
    ...
    public void SpcSampleVoice_GetsPcmTrackName_NotPlaceholder()
    {
        ...
        // from the chip + sample display name, never a raw channelId placeholder.
        // The sample identity ("Sample 03") is the pitch-side locked convention
        // (merge: pitch-side naming wins over the former "SNESDSP CH1 - PCM").
