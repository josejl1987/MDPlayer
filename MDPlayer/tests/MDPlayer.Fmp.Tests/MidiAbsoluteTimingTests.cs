...
public sealed class MidiAbsoluteTimingTests
{
    ...
    public void SerializedEvents_PreserveSourceSecondsWithinHalfTick()
    {
        ...
        int effectivePpq = export.Diagnostics.EffectivePpq;
        ...
        Assert.Equal(Ppq, effectivePpq);
        double halfTickSeconds = tempo.MicrosecondsPerQuarterNote / 1_000_000.0 / effectivePpq / 2.0;
        for (int index = 0; index < notes.Length; index++)
        {
            ...
            long tick = MidiRoundTrip.TimedEvents(export.Bytes, 1)
                ...
                .ElementAt(index)
                .Tick;
            double midiSeconds = tick * tempo.MicrosecondsPerQuarterNote / 1_000_000.0 / effectivePpq;
