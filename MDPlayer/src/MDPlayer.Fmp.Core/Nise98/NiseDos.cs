...
namespace Fmp.Core.Nise98
{
    public class NiseDos
    {
        ...
        private IFmpFileSystem _fileSystem;

        public IFmpFileSystem FileSystem
        {
            get => _fileSystem;
        ...
        public NiseDos(Register286 regs, Memory98 mem, fileTemp fileTemp, IFmpFileSystem fileSystem = null)
        {
            enc = new myEncoding();
            this.regs = regs;
            this.mem = mem;
