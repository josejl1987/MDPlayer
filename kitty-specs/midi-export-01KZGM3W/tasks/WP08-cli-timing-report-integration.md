...
# Work Package Prompt: WP08 – CLI, Timing Report & Integration Matrix
...
- **Files**: `MDPlayer/src/MDPlayer.Fmp.Cli/MidiCommand.cs`, `MDPlayer/src/MDPlayer.Fmp.Core/Timing/TimingDiagnostics.cs`, `MDPlayer/tests/MDPlayer.Fmp.Tests/MidiExportServiceTests.cs`, `MDPlayer/tests/MDPlayer.Fmp.Tests/MidiCliOptionTests.cs`.
...
- **Files**: `MDPlayer/src/MDPlayer.Fmp.Cli/MidiCommand.cs`, `MDPlayer/src/MDPlayer.Fmp.Core/Timing/TimingDiagnostics.cs`, `MDPlayer/tests/MDPlayer.Fmp.Tests/MidiCliOptionTests.cs`.
- **Parallel?**: Yes.
...
- **Files**: `MDPlayer/tests/MDPlayer.Fmp.Tests/MidiIntegrationRoundTripTests.cs` (new), `MDPlayer/tests/MDPlayer.Fmp.Tests/MusicalMidiExporterTests.cs`.
- **Parallel?**: No — depends on T036–T039 + WP05–WP07 surfaces.
...
```bash
cd /home/jose/MDPlayer && dotnet test tests/MDPlayer.Fmp.Tests/ --filter "FullyQualifiedName~MidiCliOptionTests|FullyQualifiedName~MidiExportServiceTests|FullyQualifiedName~MidiIntegrationRoundTripTests|FullyQualifiedName~MusicalMidiExporterTests"
```
